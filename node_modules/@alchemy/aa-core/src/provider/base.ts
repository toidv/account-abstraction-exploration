  ...
  implements ISmartAccountProvider<TTransport>
{
  ...
  buildUserOperation = async (
    ...
    console.log("UserOperationCallData: ", data);

    const initCode = await this.account.getInitCode();
    console.log("initCode: ", initCode);
    console.log("dummyPaymasterDataMiddleware: ", this.dummyPaymasterDataMiddleware);
    console.log(" this.feeDataGetter: ", this.feeDataGetter);
    console.log(" this.gasEstimator: ", this.gasEstimator);
    console.log(" this.paymasterDataMiddleware: ", this.paymasterDataMiddleware);
    console.log(" this.customMiddleware: ", this.customMiddleware);
    console.log(" this.noOpMiddleware: ", noOpMiddleware);
  ...
  readonly feeDataGetter: AccountMiddlewareFn = async (struct) => {
    ...
    let maxPriorityFeePerGasBid = (BigInt(maxPriorityFeePerGas) * 5n) / 3n;
